...
export const READINESS_FAQS: FaqItem[] = [
  {
    ...
    answer:
      "FACILITIES MAN is a newly established, owner-operated business based in Newcastle, NSW. We do not publish fabricated case studies, borrowed testimonials, or invented results. Our first case studies will appear here as founding contracts complete and clients give written approval. Until then, the example scope profiles on this page show the work we are ready to deliver and the standards we document from day one.",
  },
  {
    question: "How do you build a case study?",
    answer:
      "We document scope, mobilisation, outcomes, and measurable results with client approval at each stage. Photography and quotes are only published with written consent. The process typically takes 4–8 weeks after contract stabilisation. Each case study includes the original scope, the approach taken, measurable outcomes, and a client reference — all approved by the client before publication.",
  },
  {
    question: "Will my business be named in a case study?",
    answer:
      "Only with your written consent. Clients can choose to be named or remain anonymous — industry and region only — depending on confidentiality preferences. We never publish client identities, photographs, or quotes without explicit written approval. The founding-customer programme includes case study rights, but publication details are always negotiated and agreed in writing.",
  },
  {
