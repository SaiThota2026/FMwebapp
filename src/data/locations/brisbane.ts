...
export const brisbaneData: LocationPageData = {
  ...
  localCaseReference: {
    ...
    body: "No completed local case study is being claimed here — this reference outlines the type of scope FACILITIES MAN is ready to document as founding projects complete. Brisbane's body corporate sector operates under the Body Corporate and Community Management (BCCM) Act 1997, which sets out responsibilities for maintaining common property in good and serviceable repair — including cleanliness and hygiene. The 2023 amendment (commenced May 2024) introduced stronger resident protections and updated committee obligations. Brisbane's subtropical climate also creates specific cleaning challenges: mould, mildew and algae on exterior walkways, render, and bin enclosures require specialist products and targeted scheduling. As a national FM provider with QLD-vetted local resources, we deliver Newcastle-based owner oversight with local crews on the ground. The profiles below outline the type of scopes we are ready to deliver across Brisbane's key precincts.",
    scopeItems: [
      {
