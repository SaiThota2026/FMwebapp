  ...
  return (
    <>
      <PageHero
        ...
        h1="Case Studies"
        lead="Our first case studies will appear here as our founding contracts complete. Explore example scope profiles by service, industry and location — transparent outlines of the work FACILITIES MAN is equipped to deliver across Newcastle, Sydney, Brisbane and Melbourne."
      ...
      <div className="fm-container py-12 md:py-16">
        <div className="fm-section-stack">
          ...
          <RevealOnScroll>
            <SectionPanel>
              <SectionHeading>By Service, Industry &amp; Location</SectionHeading>
          ...
          <RevealOnScroll>
            <SectionPanel tone="gold">
              ...
              <div className="mt-5 space-y-4 text-brand-dark/90">
                <p>
                  Our founding-customer programme offers discounted contract
                  pricing in exchange for case study rights and a reference
                  contact. We produce the case study at no extra cost —
                  photography, write-up, and client approval managed by our team.
                  The first five clients in each region qualify.
                </p>
                <p>
